...
*	   [rtextures] qoi (Dominic Szablewski - phoboslab.org) for QOI image manage
...
*	   [rmodels] m3d (bzt) for models loading (M3D, bztsrc.gitlab.io/model3d)
...
*	   [raudio] qoa (Dominic Szablewski - phoboslab.org) for QOA audio manage
*
*
*   LICENSE: zlib/libpng
*
