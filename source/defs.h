...
/* background music thread control commands */
#define BCMX_END 0
#define BCMX_WAIT 1
#define BCMX_MAIN_MENU_LOAD 2
#define BCMX_MAIN_MENU_PLAY 3
#define BCMX_MAIN_MENU_STOP 4
#define BCMX_ARCADE_LOAD 5
#define BCMX_ARCADE_PLAY 6
#define BCMX_ARCADE_STOP 7
#define BCMX_MULTIPLAYER_LOAD 8
#define BCMX_MULTIPLAYER_PLAY 9
#define BCMX_MULTIPLAYER_STOP 10
